...
**<span style="background-color:#f3f315; padding:3px;color:#383803;">
f(n) -> O(g(n)) if   
f(n) <= C*g(n) for n > n0
</span>**
...
- ### Linked Lists
    ...
    - [x] ~~Linked List vs Arrays:~~
    	**<span style="background-color:#f3f315; padding:3px;color:#383803;">Linked List - faster to write / Arrays - faster to read.</span>**
